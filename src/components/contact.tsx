  ...
  return (
    <section id="contact" className="bg-bg-warm px-6 py-20 md:px-8 md:py-32">
      <div className="mx-auto max-w-6xl">
        <StaggerContainer>
          <StaggerItem>
            <h2 className="text-text-primary font-serif text-3xl leading-tight font-bold md:text-5xl">
          ...
          <StaggerItem className="mt-8">
            <a
              ...
              className="text-text-primary hover:text-accent inline-block cursor-pointer font-serif text-2xl underline underline-offset-8 transition-colors md:text-3xl"
            >
              {contact.email}
            </a>
          </StaggerItem>
